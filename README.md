...
| image\_cleaner\_configuration | Kubernetes image cleaner configuration. | <pre>object({<br>    enabled        = optional(bool, true)<br>    interval_hours = optional(number, 0)<br>  })</pre> | `{}` | no |
