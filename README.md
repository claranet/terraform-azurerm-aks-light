...
| advanced\_networking | Advanced networking configuration for AKS clusters using Azure CNI and cilium network\_data\_plance. | <pre>object({<br/>    observability_enabled = optional(bool, false)<br/>    security_enabled      = optional(bool, false)<br/>  })</pre> | `null` | no |
